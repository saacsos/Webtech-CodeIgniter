...
echo form_input(array(
    'name' => 'subject_code',
    'value' => (isset($post_data['subject_code']))?$post_data['subject_code']:"",
    'class' => 'form-control',
...
echo form_dropdown(
        'teacher_id', 
        $teacher_list, 
        (isset($post_data['teacher_id']))?$post_data['teacher_id']:"",
        'class=form-control'
); 
?>
</div>
<?php echo form_submit('add', 'Add Subject', 'class="btn btn-primary btn-block"'); ?>
<?php echo form_close(); ?>
    </div>
</div>